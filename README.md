...
[![Github release](https://img.shields.io/github/release/Dup4/cf-tool.svg)](https://github.com/Dup4/cf-tool/releases)
...
You can download the pre-compiled binary file in [here](https://github.com/Dup4/cf-tool/releases).
 ...
 * You can download the binary file in here https://github.com/Dup4/cf-tool (Windows, macOS, Linux)
 * Author: $%U%$
 * Time: $%Y%$-$%M%$-$%D%$ $%h%$:$%m%$:$%s%$
**/
